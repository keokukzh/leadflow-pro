      ...
      <div className="p-6 border-b border-white/5 space-y-6">
        ...
        <div className="relative group">
          ...
          <Input 
            ...
            className="pl-10 bg-white/3 border-white/10 text-white placeholder:text-white/20 focus:border-accent/30 focus:ring-accent/10 transition-all duration-500 rounded-xl" 
            value={search}
          ...
          <div className="space-y-1.5 pb-20">
            ...
            {filteredLeads.length === 0 && (
               <div className="p-12 text-center space-y-3">
                 <div className="w-12 h-12 rounded-2xl bg-white/2 border border-white/5 flex items-center justify-center mx-auto">
