      ...
      <CardFooter className="px-6 pb-6 pt-0 flex items-center gap-3">
        ...
        {result.source_url && (
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="h-12 px-4 flex items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 text-white/40 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all stagger-item text-[10px] font-bold uppercase tracking-widest"
